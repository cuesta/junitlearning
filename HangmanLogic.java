...
public class HangmanLogic 
{
	...
	private static int numberOfGuessesLeft;
	...
	public HangmanLogic(String keyPhrase, int numberOfGuesses) throws InvalidConfigurationException
	{
		...
		if(keyPhrase.equals("") || keyPhrase.equals(null))
			throw new InvalidConfigurationException("Invalid keyphrase, must not be blank or null");
		else if(numberOfGuesses < 1)
			throw new InvalidConfigurationException("Invalid number of guesses, must be one or greater");
	 ...
	 */
	public static boolean guessCharacter(char guess) throws InvalidInputException, AlreadyGuessedException
	{
	 ...
	 */
	private static boolean isValidCharacter(char guess)
	{
